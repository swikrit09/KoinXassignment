                            ...
                            <div className="lg:w-[400px] h-[151px] bg-gradient-to-br from-[#79F1A4] to-[#0E5CAD] rounded-lg flex">
                                <div className="p-3">
                                    <img
                                        ...
                                        src="https://www.investopedia.com/thmb/fetZWfPpNcafHGuQFVG2yLKTrTs=/4000x2667/filters:no_upscale():max_bytes(150000):strip_icc()/Primary-Image-how-to-buy-dogecoin-doge-7370204-429d2dbae0404ad1a75cdcfb826f75c7.jpg"
                                        alt=""
                                    />
                                </div>
                        ...
                        <div className="mt-4 lg:ml-8">
                            <div className="lg:w-[400px] h-[151px] bg-gradient-to-br from-[#FF9865] to-[#EF3031] rounded-lg flex">
                                <div className="p-3">
                                    <img
                                        className="w-32 h-32 rounded-xl object-right object-cover"
                                        src="https://cdn.zeebiz.com/sites/default/files/2023/06/24/248369-news18-bl-zb.jpg"
                                        alt=""
                                    />
                                </div>
                                <div className="items-center p-4 flex flex-col justify-center mr-10">
